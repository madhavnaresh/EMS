                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Independence of India</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            Flag hosting on red-fort by Prime minister
                            </p>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Republic of India</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            Flag hosting on red-fort by President
                            </p>
                            <p class="definition"><!--event content definition-->
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                            When an unknown printer took a galley of type and scrambled it to make a type specimen book.
                ...
                <section>
                    <div class="container">
                        <div class="date col-md-1"><!--date holder with 1 grid column-->
                            ...
                            <hr class="line"><!--css modified horizontal line-->
                            <span class="day">11</span><!--day-->
                        </div>
                        <div class="col-md-5"><!--image holder with 5 grid column-->
                            <img src="images/wedevent.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Our 1st Anniversary</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            At Mussorie restaurent 
                            </p>
                            <p class="definition"><!--event content definition-->
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                            When an unknown printer took a galley of type and scrambled it to make a type specimen book.
