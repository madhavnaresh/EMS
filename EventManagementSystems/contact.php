        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span> Madhav Gupta</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: madhav.202309028@tulas.edu.in<br>
                        <span class="glyphicon glyphicon-link"></span> Github: github.com/madhavnaresh<br>
